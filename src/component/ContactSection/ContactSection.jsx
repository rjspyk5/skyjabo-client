      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-screen-xl mx-auto">
        <div>
          ...
          <p className="text-sm mt-6 text-gray-500">
            A user-friendly platform that lets you search and book flights
            effortlessly. Find the best deals, manage bookings, and enjoy a
          ...
          <ul className="mt-10 space-y-6">
            ...
            <li className="flex items-center">
              ...
              <a href="" className="text-primary text-sm ml-3">
                ...
                <strong>imrakibul9@gmail.com</strong>
              </a>
            </li>
            <li className="flex items-center">
              <div className="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
              ...
              <a href="" className="*:text-pirmary text-sm ml-3">
                <small className="block text-primary">Address</small>
                <strong className="text-primary">186/187,Malibag,Dhaka</strong>
              </a>
            </li>
          </ul>
        </div>
        ...
        <div className="max-w-md md:ml-auto">
          ...
          <button
            type="button"
            className="text-white bg-primary hover:bg-[#fe3585] font-semibold rounded-md text-sm px-6 py-3 block w-full mt-3"
          >
            Submit
          </button>
        </div>
